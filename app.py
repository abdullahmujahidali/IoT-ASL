...
app.config['MONGO_DBNAME'] = 'ASLDB' # 'weather' is our db name on mlab
# URI (Uniform Resource Locator) is supplied by mlab. This identifies and locates where the database is on mlab
app.config['MONGO_URI'] = 'mongodb+srv://abdullah:a1b2c3d4e5@cluster0.lkglm.mongodb.net/Users?retryWrites=true&w=majority'
# 
